...
class Cli(models.Model):
    ...
    cliextcod = models.CharField(_('cliextcod'), max_length = 20,
                                 blank = True,
                                 db_index = True)
    
    clinom = models.CharField(_('clinom'), max_length = 80, blank = True,
                              db_index = True)
    clinif = models.CharField(_('clinif'), max_length = 20, blank = True,
                              db_index = True)
    ...
    cliestcod = models.ForeignKey(Est, on_delete = models.PROTECT, 
                                  null = True,
                                  blank = True,
                                  db_column = 'cliestcod')
    ...
    clitzncod = models.ForeignKey(Tzn, on_delete = models.PROTECT,
                                  db_column = 'pobtzncod')   
    cliloc = models.PointField(_('pobloc'), geography = True,
                               spatial_index = True)
...
class Pro(models.Model):
    ...
    proestcod = models.ForeignKey(Est, on_delete = models.PROTECT,
                                  null = True,
                                  blank = True,
                                  db_column = 'proestcod')    
    ...
    protzncod = models.ForeignKey(Tzn, on_delete = models.PROTECT,
                                  db_column = 'pobtzncod')   
    proloc = models.PointField(_('pobloc'), geography = True,
                               spatial_index = True)
...
class Del(models.Model):
    ...
    delestcod = models.ForeignKey(Est, on_delete = models.PROTECT, 
                                  null = True,
                                  blank = True,
                                  db_column = 'delestcod')    
...
class Dda(models.Model):
    ...
    ddaestcod = models.ForeignKey(Est, on_delete = models.PROTECT,
                                  null = True,
                                  blank = True,
                                  db_column = 'ddaestcod')    
    ...
    ddatzncod = models.ForeignKey(Tzn, on_delete = models.PROTECT,
                                  db_column = 'pobtzncod')   
    ddapol = models.PolygonField(_('ddapol'), geography = True,
                                 spatial_index = True)
